...
export const explainerPdfs = [
	{
		enTitle: 'Investigating heatwaves in China under climate change',
		enPdf: 'E01-en-investigating-heatwaves',
		cnTitle: '气候变化的背景下的中国 热浪研究',
		cnPdf: 'E01-cn-investigating-heatwaves',
		imgCredit: 'Pixaby.com'
	},
	{
		enTitle:
	...
	},
	{
		...
		cnPdf: 'E05-cn-satellite-instrument',
		imgCredit: 'WikiImages, Pixabay.com',
	...
	},
	{
		...
		cnPdf: 'E08-cn-urban-rail-transport',
	...
	},
	{
		...
		cnPdf: 'E11-cn-flood-footprint-assessment',
	...
	{
		enTitle:
			'Urgent attention needed for shift towards increasing flash droughts over China',
		enPdf: 'E16-en-flash-droughts',
		cnTitle: '聚焦中国日益严重的 骤发干旱事件',
		cnPdf: 'E16-cn-flash-droughts',
		imgCredit: 'Markus Spiske, Unsplash'
	},
	{
		enTitle: 'How will extreme cold events change over Southeast China?',
		enPdf: 'E17-en-extreme-cold',
		cnTitle: '中国东南部极端寒冷事件的未来变化趋势',
